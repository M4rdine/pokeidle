...
|---|---|
| `constants.ts` | `SNAPSHOT_EVERY_TICKS = 50`, `SYNC_EVERY_TICKS = 300`, `CATCHUP_SLICE_TICKS = 250`, `MAX_CATCHUP_TICKS = 216_000`, `MIN_CATCHUP_TICKS = 5`, `INTENT_MIN_INTERVAL_MS = 200`, `WS_MAX_MESSAGE_BYTES = 4096`, `WS_MAX_INVALID_IN_A_ROW = 3`, `WS_PING_MS = 30_000`, `WS_PONG_TIMEOUT_MS = 60_000`, `WS_SESSION_RECHECK_MS = 300_000`, `TICK_LAG_WARN_MS = 1000`. `TICK_MS` vem do `shared`. |
