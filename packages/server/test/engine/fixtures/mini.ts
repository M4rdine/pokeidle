...
export function miniRegistry(): Registry {
  return buildRegistry({
    ...
    regions: [{
      ...
      townMap: 'kanto',
      areas: [{ id: 'mini', name: 'Mini', bounds: { x: 0, y: 0, width: 5, height: 5 }, anchor: { x: 2, y: 2 }, noMapa: { x: 20, y: 30, local: 'Rota 1' }, species: ['zubat'], minLevel: 3, maxLevel: 3, wildCount: 3, respawnSeconds: 20, minTrainerLevel: 1, rarity: 1 }],
    }],
    hunts: [miniHunt()],
  })
}
