...
const minimal = () => ({
  ...
  regions: [{ id: 'kanto', name: 'Kanto', order: 1, minTrainerLevel: 1, width: 1, height: 2, areas: [{ id: 'r', name: 'R', bounds: { x: 0, y: 0, width: 1, height: 2 }, anchor: { x: 0, y: 1 }, species: ['charmander'], minLevel: 1, maxLevel: 3, wildCount: 3, respawnSeconds: 20, minTrainerLevel: 1, rarity: 1 }] }],
